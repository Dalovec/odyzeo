        ...
        <form class="bg-slate-100 w-1/3 rounded-lg shadow-2xl m-auto" method="post" action="{{route('ticket-submit')}}" enctype="multipart/form-data">
            <div class="m-12 mt-14">
                <label for="meno">
                    ...
                    <input class="block w-full h-10 rounded shadow-md mb-4 p-4 mt-2 focus:h-12 duration-300 font-light" type="text" name="meno" id="meno">
                </label>
                <label for="mail">
                ...
                <label for="správa">
                    ...
                    <textarea class="block w-full h-40 rounded shadow-md mb-4 p-4 mt-2 max-h-48 min-h-32 font-light" name="správa" id="správa"></textarea>
                </label>
                <label for="file">
